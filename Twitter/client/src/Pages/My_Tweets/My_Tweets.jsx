...
const My_Tweets = React.memo(({ user, avatar, fullName, newTweet, tweets }) => {
    ...
    return (
        <div className="main_content tweetPage">
                ...
                <div className="tweet_wrap_post">
                    ...
                    <form onSubmit={onSubmitForm}>
                        ...
                        <div className="tweet_wrap_panel">
                            ...
                            <div className="button_wrap"><Button disable={textValue ? false : true} color="yellow">Tweet</Button></div>
                        </div>
                    </form>
                </div>
            ...
            {tweets.length === 0 && <h3 className="error_tweets">You have 0 Tweets</h3>}
            {
                tweets
                    ? tweets.sort((a, b) => {
